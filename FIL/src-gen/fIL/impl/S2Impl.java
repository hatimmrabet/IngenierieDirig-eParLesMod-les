...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>S2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fIL.impl.S2Impl#getUes <em>Ues</em>}</li>
 *   <li>{@link fIL.impl.S2Impl#getUesoptionnelles <em>Uesoptionnelles</em>}</li>
 *   <li>{@link fIL.impl.S2Impl#getUesobligatoires <em>Uesobligatoires</em>}</li>
 * </ul>
 *
 * @generated
 */
public class S2Impl extends MinimalEObjectImpl.Container implements S2 {
	/**
	...
	public EList<UE> getUes() {
		if (ues == null) {
			ues = new EObjectContainmentEList<UE>(UE.class, this, FILPackage.S2__UES);
		}
		return ues;
	}
	...
	public EList<UE> getUesoptionnelles() {
		if (uesoptionnelles == null) {
			uesoptionnelles = new EObjectResolvingEList<UE>(UE.class, this, FILPackage.S2__UESOPTIONNELLES);
		}
	...
	public EList<UE> getUesobligatoires() {
		if (uesobligatoires == null) {
			uesobligatoires = new EObjectResolvingEList<UE>(UE.class, this, FILPackage.S2__UESOBLIGATOIRES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case FILPackage.S2__UES:
			return getUes();
		case FILPackage.S2__UESOPTIONNELLES:
			return getUesoptionnelles();
		case FILPackage.S2__UESOBLIGATOIRES:
