...
/**
 * This is the item provider adapter for a {@link fIL.Formation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPseudoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Formation_pseudo_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Formation_pseudo_feature",
								"_UI_Formation_type"),
						FILPackage.Literals.FORMATION__PSEUDO, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
