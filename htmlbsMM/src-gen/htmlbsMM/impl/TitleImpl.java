...
public class TitleImpl extends ContentImpl implements Title {
	 ...
	 * @ordered
	 */
	protected static final int LEVEL_EDEFAULT = 2;
	...
	protected EClass eStaticClass() {
		return HtmlbsMMPackage.Literals.TITLE;
	}
	...
	public void setLevel(int newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlbsMMPackage.TITLE__LEVEL, oldLevel, level));
	}
