 ...
 * </p>
 * <ul>
 *   <li>{@link htmlbsMM.impl.ButtonImpl#getPage <em>Page</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ButtonImpl extends RedirectionURLImpl implements Button {
	...
	protected EClass eStaticClass() {
		return HtmlbsMMPackage.Literals.BUTTON;
	}
		...
		if (page != null && page.eIsProxy()) {
			...
			if (page != oldPage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HtmlbsMMPackage.BUTTON__PAGE, oldPage,
							page));
			}
		}
		return page;
	...
	public void setPage(Page newPage) {
		...
		page = newPage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlbsMMPackage.BUTTON__PAGE, oldPage, page));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case HtmlbsMMPackage.BUTTON__PAGE:
			if (resolve)
				return getPage();
			return basicGetPage();
		}
