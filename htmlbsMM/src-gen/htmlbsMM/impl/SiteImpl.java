...
public class SiteImpl extends MinimalEObjectImpl.Container implements Site {
	...
	protected EClass eStaticClass() {
		return HtmlbsMMPackage.Literals.SITE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlbsMMPackage.SITE__NAME, oldName, name));
	}
	...
	public EList<Page> getPages() {
		if (pages == null) {
			pages = new EObjectContainmentEList<Page>(Page.class, this, HtmlbsMMPackage.SITE__PAGES);
		}
		return pages;
	}
