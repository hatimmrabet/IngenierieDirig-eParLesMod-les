 ...
 * </p>
 * <ul>
 *   <li>{@link htmlbsMM.impl.ContentImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ContentImpl extends MinimalEObjectImpl.Container implements Content {
	...
	protected EClass eStaticClass() {
		return HtmlbsMMPackage.Literals.CONTENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlbsMMPackage.CONTENT__NAME, oldName, name));
	}
