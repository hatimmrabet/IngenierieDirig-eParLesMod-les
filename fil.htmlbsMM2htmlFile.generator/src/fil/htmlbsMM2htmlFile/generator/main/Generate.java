 ...
 *******************************************************************************/
package fil.htmlbsMM2htmlFile.generator.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/fil/htmlbsMM2htmlFile/generator/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(htmlbsMM.HtmlbsMMPackage.class)) {
            resourceSet.getPackageRegistry().put(htmlbsMM.HtmlbsMMPackage.eINSTANCE.getNsURI(), htmlbsMM.HtmlbsMMPackage.eINSTANCE);
        }
